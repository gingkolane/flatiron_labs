...
export default class MovieCard extends Component {
  ...
  render() {
    // const poster = this.props.oneMovie.poster;
    // const title = this.props.oneMovie.title;
    // const IMDBRating = this.props.oneMovie.IMDBRating;
    // const genres = this.props.oneMovie.genres;
    const { poster, title, IMDBRating, genres } = this.props.oneMovie
